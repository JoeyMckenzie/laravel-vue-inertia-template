...
const classes = computed(() =>
    props.active
        ? 'inline-flex items-center px-1 pt-1 border-b-2 border-neutral-400 text-sm font-medium leading-5 focus:outline-none focus:border-neutral-700 transition duration-150 ease-in-out'
